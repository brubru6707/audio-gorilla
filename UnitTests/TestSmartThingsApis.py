...
class TestSmartThingsApis(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Load real data from backend to get user UUIDs
        real_data = BackendDataLoader.get_smart_things_data()
        
        # Extract real user UUIDs (not emails!)
        user_ids = list(real_data.get("users", {}).keys())
        self.user_id = user_ids[0] if user_ids else "user_001"
        
        # Get actual loaded data for testing using the UUID
        devices = self.smart_things_api.list_devices(user_id=self.user_id)
        locations = self.smart_things_api.list_locations(user_id=self.user_id)
        rooms = self.smart_things_api.list_rooms(user_id=self.user_id)
    ...
    def test_get_user_profile_success(self):
        ...
        result = self.smart_things_api.get_user_profile(user_id=self.user_id)
    ...
    def test_get_device_success(self):
        ...
        device = self.smart_things_api.get_device(self.first_device_id, user_id=self.user_id)
    ...
    def test_get_device_not_found(self):
        ...
        device = self.smart_things_api.get_device("nonexistent-device-id", user_id=self.user_id)
    ...
    def test_get_device_status_not_found(self):
        ...
        status = self.smart_things_api.get_device_status("nonexistent-device-id", user_id=self.user_id)
    ...
    def test_delete_device_success(self):
        ...
        result = self.smart_things_api.delete_device(self.first_device_id, user_id=self.user_id)
    ...
    def test_delete_device_not_found(self):
        ...
        result = self.smart_things_api.delete_device("nonexistent-device-id", user_id=self.user_id)
    ...
    def test_get_device_health_success(self):
        ...
        health = self.smart_things_api.get_device_health(self.first_device_id, user_id=self.user_id)
    ...
    def test_list_devices_by_health_status(self):
        ...
        devices = self.smart_things_api.list_devices_by_health_status("online", user_id=self.user_id)
        self.assertIsInstance(devices, list)
    ...
    def test_list_devices_by_manufacturer(self):
        ...
        devices = self.smart_things_api.list_devices_by_manufacturer("SmartThings", user_id=self.user_id)
        self.assertIsInstance(devices, list)
    ...
    def test_update_device_firmware_success(self):
        ...
        result = self.smart_things_api.update_device_firmware(self.first_device_id, "v2.0.0", user_id=self.user_id)
        self.assertEqual(result["status"], "success")
    ...
    def test_get_location_success(self):
        ...
        location = self.smart_things_api.get_location(self.first_location_id, user_id=self.user_id)
    ...
    def test_get_location_not_found(self):
        ...
        location = self.smart_things_api.get_location("nonexistent-location-id", user_id=self.user_id)
        self.assertIn("error", location)

    def test_create_location_success(self):
        """Test creating a new location."""
        result = self.smart_things_api.create_location(name="Test Location", user_id=self.user_id)
        self.assertIsInstance(result, dict)
        self.assertEqual(result["status"], "success")
    ...
    def test_delete_location_success(self):
        ...
        result = self.smart_things_api.delete_location(self.first_location_id, user_id=self.user_id)
        self.assertEqual(result["status"], True)
    ...
    def test_get_room_success(self):
        ...
        room = self.smart_things_api.get_room(self.first_room_id, user_id=self.user_id)
    ...
    def test_get_room_not_found(self):
        ...
        room = self.smart_things_api.get_room("nonexistent-room-id", user_id=self.user_id)
        self.assertIn("error", room)

    def test_create_room_success(self):
        """Test creating a new room."""
        result = self.smart_things_api.create_room(name="Test Room", user_id=self.user_id)
        self.assertIsInstance(result, dict)
        self.assertEqual(result["status"], "success")
    ...
    def test_delete_room_success(self):
        ...
        result = self.smart_things_api.delete_room(self.first_room_id, user_id=self.user_id)
        self.assertEqual(result["status"], True)
    ...
    def test_list_capabilities(self):
        ...
        capabilities = self.smart_things_api.list_capabilities(user_id=self.user_id)
    ...
    def test_get_capability_success(self):
        ...
        capability = self.smart_things_api.get_capability("switch", user_id=self.user_id)
    ...
    def test_get_capability_not_found(self):
        ...
        capability = self.smart_things_api.get_capability("nonexistent-capability", user_id=self.user_id)
    ...
    def test_device_lifecycle(self):
        ...
        created = self.smart_things_api.create_device(**device_data, user_id=self.user_id)
    ...
    def test_location_room_hierarchy(self):
        ...
        # Create location
        location = self.smart_things_api.create_location(name="Hierarchy Test Location", user_id=self.user_id)
        location_id = location["location"]["id"]

        # Create room in location
        room = self.smart_things_api.create_room(name="Hierarchy Test Room", user_id=self.user_id, location_id=location_id)
        room_id = room["room"]["id"]

        # Verify room belongs to location
        retrieved_room = self.smart_things_api.get_room(room_id, user_id=self.user_id)
        self.assertEqual(retrieved_room["location_id"], location_id)

        # List rooms for location
        rooms = self.smart_things_api.list_rooms(user_id=self.user_id, location_id=location_id)
    ...
    def test_reset_data(self):
        ...
        self.smart_things_api.create_device(**device_data, user_id=self.user_id)
    ...
    def test_invalid_device_operations(self):
        ...
        result = self.smart_things_api.get_device(None, user_id=self.user_id)
        self.assertIn("error", result)

        # Test with empty string
        result = self.smart_things_api.get_device("", user_id=self.user_id)
        self.assertIn("error", result)

    def test_invalid_location_operations(self):
        """Test operations with invalid location IDs."""
        result = self.smart_things_api.get_location("invalid-location", user_id=self.user_id)
        self.assertIn("error", result)

    def test_invalid_room_operations(self):
        """Test operations with invalid room IDs."""
        result = self.smart_things_api.get_room("invalid-room", user_id=self.user_id)
        self.assertIn("error", result)
